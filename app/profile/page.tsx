...
function ProfilePage() {
  ...
  if (currentUser && currentUserData) {
    return (
      <div className="text-zinc-800 dark:text-neutral-100 w-full">
        ...
        <div className=" flex p-4 flex-col md:flex-row">
          <div className="flex flex-col md:w-1/2 w-full space-y-4 p-4">
            <div className="flex p-4 rounded-lg bg-neutral-200 dark:bg-neutral-900 w-full justify-center text-left items-center">
            ...
            <div className="flex flex-col p-4 rounded-lg bg-neutral-200 dark:bg-neutral-900 w-full justify-center text-left items-center">
          ...
          <div className="flex flex-col p-4 md:w-1/2 w-full">
            <div className="flex flex-col space-y-2 p-4 rounded-lg bg-neutral-200 dark:bg-neutral-900 w-full">
              <SessionDropdown
